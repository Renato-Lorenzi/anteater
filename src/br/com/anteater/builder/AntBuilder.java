...
public class AntBuilder extends BuilderSupport {
	...
	// true when inside a task so special ant.target handling occurs just at top
	// level
	boolean insideTask;
	...
	public AntBuilder(final Task parentTask) {
		...
		// define "owning" task as wrapper to avoid having tasks added to the
		// target
	...
	protected static Project createProject() {
		...
		helper.getImportStack().addElement("AntBuilder"); // import checks that
															// stack is not
															// empty
	 ...
	 * {@link #createNode(Object, Map, Object)} but the one made ready by
	 * {@link #nodeCompleted(Object, Object)}
	 * 
	...
	// Copied from org.apache.tools.ant.Task, since we need to get a real thing
	// before it gets nulled in DispatchUtils.execute
